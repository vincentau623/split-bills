...
export const billSlice = createSlice({
    ...
    reducers: {
        ...
        updateBillItem: (state, action: PayloadAction<{ index: number, billItem: BillItem }>) => {
            state.value.billItems[action.payload.index] = action.payload.billItem
        },
        ...
        updatePerson: (state, action: PayloadAction<{ index: number, person: Person }>) => {
...
export const {
    addBillItem, removeBillItem, updateBillItem,
